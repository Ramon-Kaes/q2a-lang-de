...
*/
	...
	return array(
		...
		'anonymous' => 'Anonym',
		'answer_edited' => 'Antwort bearbeitet',
		'answer_reshown' => 'Antwort erneut angezeigt',
		'answer_selected' => 'Antwort ausgewählt',
		'answered' => 'Beantwortet',
		'answered_qs_in_x' => 'Meist beantwortete Fragen in ^',
		'answered_qs_title' => 'Am meisten beantwortete Fragen',
		'asked' => 'Gefragt',
		...
		'comment_reshown' => 'Kommentar erneut angezeigt',
		'commented' => 'Kommentiert', // groß oder klein?
		...
		'edited' => 'Bearbeitet', // groß oder klein?
		'email_error' => 'Beim Versuch, die E-Mail zu senden, ist ein Fehler aufgetreten.',
		'field_required' => 'Bitte gib etwas in dieses Feld ein',
		...
		'hidden' => 'versteckt',
		'highest_users' => 'User mit höchster Punktezahl',
		...
		'max_upload_size_x' => 'Maximale Upload-Größe ist ^',
		'me' => 'mir',
		...
		'nav_feedback' => 'Kommentare und Anregungen', // Feedback senden
		'nav_home' => 'Startseite',
		'nav_hot' => 'Beliebt!',
		'nav_login' => 'Anmelden',
		'nav_logout' => 'Abmelden',
		...
		'nav_qa' => 'Q&amp;A',
		'nav_qs' => 'Alle Fragen', // Fragen
		'nav_register' => 'Registrieren',
		'nav_tags' => 'Tags',
		'nav_unanswered' => 'Unbeantwortet',
		'nav_updates' => 'Meine Updates', // Neuigkeiten
		'nav_users' => 'User',
		...
		'questions_tagged_x' => 'Neueste Fragen mit ^-Tag',
		'recategorized' => 'Kategorie geändert', // recategorized
		'recent_activity_in_x' => 'Letzte Aktivität in ^',
		'recent_activity_title' => 'Letzte Aktivitäten',
		'recent_as_in_x' => 'Zuletzt beantwortete Fragen in ^',
		'recent_as_title' => 'Zuletzt beantwortete Fragen',
		'recent_cs_in_x' => 'Letzte kommentierte Fragen in ^',
		'recent_cs_title' => 'Letzte kommentierte Fragen',
		...
		'since_x' => 'seit ^',
		'suggest_ask' => 'Mache den Anfang und ^1stelle eine Frage^2.',
		'suggest_category_qs' => '^1Alle Fragen in dieser Kategorie anzeigen^2.',  // check
		'suggest_qs' => '^1Alle Fragen anzeigen^2.', // check
		...
		'unupvoteda_qs_in_x' => 'Neue Fragen ohne Antwort mit positiver Bewertung in ^',
		...
		'vote_disabled_approve' => 'Dein Konto muss zum Bewerten freigegeben werden.',
		'vote_disabled_down' => 'Nur bestimmte Konten dürfen Abwertungen vergeben',
		'vote_disabled_down_approve' => 'Dein Konto muss zum Abwerten freigegeben werden',
		'vote_disabled_hidden_post' => "Versteckte Einträge können nicht bewertet werden",
		...
		'vote_disabled_level' => 'Bewertungen sind nur für bestimmte User verfügbar',
		'vote_disabled_my_post' => "Du kannst deine eigenen Einträge nicht bewerten",
		'vote_disabled_my_a' => 'Du kannst für deine eigenen Antworten keine Punkte vergeben',
		'vote_disabled_my_q' => 'Du kannst für deinen eigenen Fragen keine Punkte vergeben',
		'vote_disabled_q_page_only' => 'Bitte prüfe die Frage, um Punkte zu vergeben',
		'vote_disabled_queued' => "Nur bestätigte Einträge können bewertet werden",
